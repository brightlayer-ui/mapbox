...
echo -ne "  dark theme: "
if [ ! -f ./dark.json ]; then echo -e "${RED}Not Found${NC}" && exit 1; else echo -e "${GREEN}Found${NC}"; fi
echo -ne "  light theme: "
if [ ! -f ./default.json ]; then echo -e "${RED}Not Found${NC}" && exit 1; else echo -e "${GREEN}Found${NC}"; fi
echo -ne "  license: "
...
echo -e "\r\n${GREEN}-----------------------------------"
echo -e "Mapbox package successfully created"
echo -e "-----------------------------------${NC}\r\n\r\n"
